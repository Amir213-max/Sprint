      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service: any, index: number) => (
            <div
              key={service.id}
              className="bg-[var(--bg-card)] p-8 rounded-lg shadow-md hover:shadow-xl transition-all border border-[var(--border-primary)] transform hover:scale-105 animate-fade-in-up"
